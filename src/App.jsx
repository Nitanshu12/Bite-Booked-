            ...
            <div className="relative w-full h-full flex flex-col justify-center p-8">
              ...
              <form className="space-y-4 mt-4">
                <div>
                  ...
                  <input type="text" placeholder="Enter here..." className="w-full p-3 bg-gray-100 rounded" />
                </div>
                <div>
                ...
                <div>
                  ...
                  <input type="email" placeholder="Enter here..." className="w-full p-3 bg-gray-100 rounded" />
                </div>
